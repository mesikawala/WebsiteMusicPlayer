...
let songs = [
    {
        ...
        albumArtUrl: "./img/Multo.jpg",
        audioSrc: "audio/Multo.mp3",
        videoBgSrc: "videos/Multo.mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
        lyrics: [
            { time: 0.1, text: "Hindi na makalaya, dinadalaw mo 'ko bawat gabi" },
            { time: 9, text: "Wala mang nakikita, haplos mo'y ramdam pa rin sa dilim," },
            { time: 18, text: "Hindi na na-nanaginip, hindi na ma-makagising" },
            { time: 27, text: "Pasindi na ng ilaw" },
            { time: 32, text: "Minumulto na 'ko ng damdamin ko, ng damdamin ko" },
            { time: 38, text: "Hindi mo ba ako lilisanin?" },
            { time: 42, text: "Hindi pa ba sapat pagpapahirap sa 'kin? (Ng damdamin ko)" },
            { time: 47, text: "Hindi na ba ma-mamamayapa?" },
            { time: 52, text: "Hindi na ba ma-mamamayapa?" },
            { time: 55, text: "Hindi na makalaya, dinadalaw mo 'ko bawat gabi" },
            { time: 105, text: "Wala mang nakikita, haplos mo'y ramdam pa rin sa dilim" },
        ]
    },
    {
        id: 2,
